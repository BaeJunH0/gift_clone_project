...
public class WishListServiceTest {
    ...
    void test1() {
        ...
        Product product = new Product("product", 15000, "url", category);
    ...
    void test3(){
        ...
        Category  category = new Category("신규", "", "", "");
        for (int i = 1; i <= 5; i++) {
            Product product = new Product("product" + i, 4000, "url" + i, category);
            WishProduct wishProduct = new WishProduct(user, product);
        ...
        // when
        Page<WishProductResponse> pageResult = wishListService.findWishList(1L, pageable);
        // then
