...
public class UserRepositoryTest {
    ...
    @BeforeEach
    void init(){
        User user1 = new User("one@email.com", "1111");
        userRepository.save(user1);

        User user2 = new User("two@email.com", "2222");
        userRepository.save(user2);

        User user3 = new User("three@email.com", "3333");
        userRepository.save(user3);

        User user4 = new User("four@email.com", "4444");
        userRepository.save(user4);

        User user5 = new User("five@email.com", "5555");
    ...
    void saveTest(){
        // when
        User user = new User("six@email.com", "6666");
